...
<FORM METHOD="post" ACTION="ProductComparison.php">
	...
	HP Omen 17 <input type="checkbox" name="HPOMEN17" value=6 /></br>
	Lenovo IdeaPad 110 <input type="checkbox" name="LENOVOIP110" value=7 /></br>
	Apple MacBook Air 13 <input type="checkbox" name="MBAIR13" value=8 /></br></br>
    <input type="submit" />
</FORM>
</BODY>
</HTML>
